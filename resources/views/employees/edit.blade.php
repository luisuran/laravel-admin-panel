    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
                <form method="POST" action="{{ route('employees.update', $employee) }}" class="bg-white p-6 rounded-lg shadow-md" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="p-6 text-gray-900">
                        <div class="flex flex-col pb-3">
                            <label for="first_name" class="mb-2">First Name</label>
                            <input type="text" name="first_name" id="first_name" value="{{ $employee->first_name }}" class="border-2 border-gray-300 p-2 rounded-lg">
                        ...
                        <div class="flex flex-col pb-3">
                            ...
                            <input type="text" name="last_name" id="last_name" value="{{ $employee->last_name }}" class="border-2 border-gray-300 p-2 rounded-lg">
                        ...
                        <div class="flex flex-col pb-3">
                            ...
                            <input type="text" name="email" id="email" value="{{ $employee->email }}" class="border-2 border-gray-300 p-2 rounded-lg">
                            @if ($errors->has('email'))
                        ...
                        <div class="flex flex-col pb-3">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ $employee->phone }}" class="border-2 border-gray-300 p-2 rounded-lg">
                            @if ($errors->has('phone'))
